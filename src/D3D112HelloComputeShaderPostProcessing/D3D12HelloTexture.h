...
private:
    ...
    ComPtr<ID3D12DescriptorHeap> m_rtvHeap; UINT m_rtvDescriptorSize;
    ...
    ComPtr<ID3D12PipelineState> m_renderFromTex_pipelineState;

    ComPtr<ID3D12Resource> m_renderFromTex_vertexBuffer_upload;
    ComPtr<ID3D12Resource> m_renderFromTex_vertexBuffer_default;
    D3D12_VERTEX_BUFFER_VIEW m_renderFromTex_vbv;

    ComPtr<ID3D12Resource> m_renderFromTex_textureRes_upload;
    ComPtr<ID3D12Resource> m_renderFromTex_textureRes_default;
    ComPtr<ID3D12DescriptorHeap> m_renderFromTex_srvHeap;
    ComPtr<ID3D12DescriptorHeap> m_renderFromTex_rtvHeap;
    ...
    void LoadPipeline();
    void LoadAssets();
    void LoadAssets_renderFromTex();
    void PopulateCommandList_renderToTexture(int);
    void PopulateCommandList_renderFromTex();
