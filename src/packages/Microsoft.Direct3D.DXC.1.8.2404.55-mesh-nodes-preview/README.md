...
For details, see the [DirectX Blog post](https://devblogs.microsoft.com/directx/d3d12-mesh-nodes-in-work-graphs) and the [mesh nodes section](https://microsoft.github.io/DirectX-Specs/d3d/WorkGraphs.html#mesh-nodes) of the work graphs spec.
To make use of these new work graph nodes, build with the `-T lib_6_9` flag.
